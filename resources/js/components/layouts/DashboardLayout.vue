<template>
  <v-container style="-webkit-app-region: drag">
    ...
    >
      ...
      <v-list-item two-line :class="miniVariant && 'px-0'">
        ...
        <v-list-item-content v-if="user">
            <v-list-item-title><span color="white">{{ user.firstname }}</span></v-list-item-title>
...
export default {
  ...
  data: () => ({
    ...
    items: [
      ...
      {icon:'mdi-chart-pie', text:'Analytics', route:'/analytics'},
      // {
      //   icon:'mdi-chevron-up',
